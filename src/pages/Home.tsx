  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="text-center animate-slide-up">
            <div className="flex items-center justify-center mb-6">
              <div className="flex items-center">
                <div className="bg-gradient-to-r from-purple-600 to-blue-600 p-4 rounded-3xl mr-4 shadow-xl">
              ...
              <div className="relative group">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-8 py-5 glass-card glass-hover rounded-3xl text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent shadow-md transition-all duration-200 text-lg font-medium"
                  />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-10">
          <div className="glass-card glass-hover rounded-3xl p-8 shadow-md">
              ...
              {GAME_CATEGORIES.map((category) => {
                ...
                return (
                  <button
                    ...
                    className={`px-8 py-4 rounded-2xl font-semibold transition-colors duration-200 ${
                      isActive
                        ? 'bg-gradient-to-r from-purple-600 to-blue-600 text-gray-100 shadow-md'
                        : 'glass glass-hover text-gray-300 hover:text-gray-100'
                    }`}
                  >
        ...
        {filteredGames.length > 0 ? (
          ...
          <div className="text-center py-20">
            <div className="glass-card glass-hover rounded-3xl p-16 shadow-md max-w-3xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                {searchTerm && (
                  <button
                    onClick={() => setSearchTerm("")}
                    className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-gray-100 px-8 py-4 rounded-2xl font-semibold transition-colors duration-200 group"
                  >
                    <div className="flex items-center space-x-3">
                ...
                {selectedCategory !== "Semua" && (
                  <button
                    ...
                    className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-gray-100 px-8 py-4 rounded-2xl font-semibold transition-colors duration-200 group"
                  >
                    <div className="flex items-center space-x-3">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
