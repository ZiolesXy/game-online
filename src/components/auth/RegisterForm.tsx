      ...
      <div className="max-w-md w-full space-y-8">
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-purple-100">Create your gaming account</p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-5">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-purple-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent backdrop-blur-sm"
              ...
              <div>
                <label htmlFor="fullName" className="block text-sm font-medium text-purple-100 mb-2">
                  Full Name <span className="text-purple-300">(Optional)</span>
                </label>
                <div className="relative">
                  <input
                    type="text"
                ...
                {formData.password && (
                  <div className="mt-2">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-xs text-purple-200">{strengthLabels[passwordStrength - 1] || 'Too weak'}</span>
                    </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-purple-100">
              ...
              <button
                onClick={onToggleMode}
                className="text-purple-300 hover:text-white font-medium underline decoration-2 underline-offset-2 transition-colors"
              >
                Sign in here
              </button>
            </p>
